...
public class InvoiceA {
    ...
    public InvoiceA(String partNumber, String partDescription, int quantity, double pricePerItem) {
    ...
    public void setPricePerItem(double pricePerItem) { this.pricePerItem = pricePerItem > 0.0 ? pricePerItem : 0.0; }
...
class InvoiceB {
    ...
    public InvoiceB(String partNumber, String partDescription, int quantity, double pricePerItem) {
        this.partNumber = partNumber;
        this.partDescription = partDescription;
        this.quantity = quantity > 0 ? quantity : 0;
        this.pricePerItem = pricePerItem > 0.0 ? pricePerItem : 0.0;
